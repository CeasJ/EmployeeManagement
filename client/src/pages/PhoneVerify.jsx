...
const PhoneVerify = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.post('http://localhost:5000/api/auth/validateAccessCode', {
        accessCode: code,
        phoneNumber: phone
      });
  ...
  const handleResend = async () => {
    ...
    setIsLoading(true);
    try {
      await axios.post('http://localhost:5000/api/auth/createAccessCode', {
        phoneNumber: phone
      });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-semibold text-gray-900 mb-2">Phone verification</h1>
